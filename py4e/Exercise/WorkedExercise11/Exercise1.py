...
•	Actual data: http://py4e-data.dr-chuck.net/regex_sum_1755532.txt (There are 106 values and the sum ends with 841)
...
Note:
Each student will have a distinct data file for the assignment - so only use your own data file for analysis.
Data Format
